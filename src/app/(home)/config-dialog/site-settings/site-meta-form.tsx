		...
		<>
			<div className='grid grid-cols-2 gap-2'>
				<div>
					...
					<input
						...
						onChange={(e: React.ChangeEvent<HTMLInputElement>) => setFormData({ ...formData, meta: { ...formData.meta, title: e.target.value } })}
				...
				<div>
					...
					<input
						...
						onChange={(e: React.ChangeEvent<HTMLInputElement>) => setFormData({ ...formData, meta: { ...formData.meta, username: e.target.value } })}
						className='bg-secondary/10 w-full rounded-lg border px-4 py-2 text-sm'
					/>
				</div>
			</div>
			...
			<div>
				...
				<textarea
					...
					onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => setFormData({ ...formData, meta: { ...formData.meta, description: e.target.value } })}
					rows={3}
					className='bg-secondary/10 w-full rounded-lg border px-4 py-2 text-sm'
				/>
			</div>
