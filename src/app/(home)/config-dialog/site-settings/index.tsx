			...
			<div className='flex gap-3'>
				<label className='flex items-center gap-2'>
					<input
						...
						onChange={(e: React.ChangeEvent<HTMLInputElement>) => setFormData({ ...formData, clockShowSeconds: e.target.checked })}
				...
				<label className='flex items-center gap-2'>
					<input
						...
						onChange={(e: React.ChangeEvent<HTMLInputElement>) => setFormData({ ...formData, summaryInContent: e.target.checked })}
						className='accent-brand h-4 w-4 rounded'
					/>
				...
				<label className='flex items-center gap-2'>
					<input
						...
						onChange={(e: React.ChangeEvent<HTMLInputElement>) => setFormData({ ...formData, hideEditButton: e.target.checked })}
						className='accent-brand h-4 w-4 rounded'
					/>
			...
			<div className='flex gap-3'>
				<label className='flex items-center gap-2'>
					<input
						...
						onChange={(e: React.ChangeEvent<HTMLInputElement>) => setFormData({ ...formData, isCachePem: e.target.checked })}
						className='accent-brand h-4 w-4 rounded'
					/>
				...
				<label className='flex items-center gap-2'>
					<input
						...
						onChange={(e: React.ChangeEvent<HTMLInputElement>) => setFormData({ ...formData, enableCategories: e.target.checked })}
						className='accent-brand h-4 w-4 rounded'
					/>
				...
				<label className='flex items-center gap-2'>
					<input
						...
						onChange={(e: React.ChangeEvent<HTMLInputElement>) => setFormData({ ...formData, enableChristmas: e.target.checked })}
						className='accent-brand h-4 w-4 rounded'
					/>
