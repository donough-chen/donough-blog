		...
		<div className='relative px-6 pt-32 pb-12 text-sm max-sm:pt-28'>
			<div className='mx-auto flex max-w-3xl flex-col gap-6'>
				...
				<motion.label
					...
					<input type='file' accept='image/*' multiple className='hidden' onChange={(event: React.ChangeEvent<HTMLInputElement>) => handleFiles(event.target.files)} />
							...
							<div>
								...
								<div className='flex items-center gap-3 pt-2'>
									<input
										...
										step={0.05}
										value={quality}
										onChange={(event: React.ChangeEvent<HTMLInputElement>) => setQuality(parseFloat(event.target.value))}
							...
							<div className='flex items-center gap-3'>
								<div className='flex items-center gap-2'>
									<input
										...
										onChange={(event: React.ChangeEvent<HTMLInputElement>) => setLimitMaxWidth(event.target.checked)}
								...
								{limitMaxWidth && (
									<div className='flex items-center gap-2'>
										<input
											...
											step={100}
											value={maxWidth}
											onChange={(event: React.ChangeEvent<HTMLInputElement>) => setMaxWidth(Math.max(100, parseInt(event.target.value) || 1200))}
