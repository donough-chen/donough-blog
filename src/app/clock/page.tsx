						...
						<div className='flex items-center justify-center gap-4'>
							<div className='flex flex-col items-center gap-2'>
								...
								<input
									...
									onChange={(e: React.ChangeEvent<HTMLInputElement>) => setTimerInput({ ...timerInput, hours: Math.max(0, Math.min(23, parseInt(e.target.value) || 0)) })}
							...
							<div className='flex flex-col items-center gap-2'>
								...
								<input
									...
									onChange={(e: React.ChangeEvent<HTMLInputElement>) => setTimerInput({ ...timerInput, minutes: Math.max(0, Math.min(59, parseInt(e.target.value) || 0)) })}
									className='no-spinner w-20 rounded-xl border bg-white/60 px-4 py-3 text-center text-2xl font-bold backdrop-blur-sm focus:bg-white/80'
								/>
							</div>
							<div className='text-secondary mt-8 text-2xl font-bold'>:</div>
							<div className='flex flex-col items-center gap-2'>
								...
								<input
									...
									onChange={(e: React.ChangeEvent<HTMLInputElement>) => setTimerInput({ ...timerInput, seconds: Math.max(0, Math.min(59, parseInt(e.target.value) || 0)) })}
									className='no-spinner w-20 rounded-xl border bg-white/60 px-4 py-3 text-center text-2xl font-bold backdrop-blur-sm focus:bg-white/80'
								/>
							</div>
						</div>
