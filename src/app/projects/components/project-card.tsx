	...
	return (
		<motion.div
				...
				<div className='flex-1'>
					<div className='flex items-center gap-2'>
						<h3
							...
							onBlur={(e: React.FocusEvent<HTMLHeadingElement>) => handleFieldChange('name', e.currentTarget.textContent || '')}
						...
						{canEdit ? (
							<input
								...
								onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleFieldChange('year', parseInt(e.target.value) || 0)}
			...
			<p
				contentEditable={canEdit}
				suppressContentEditableWarning
				onBlur={(e: React.FocusEvent<HTMLParagraphElement>) => handleFieldChange('description', e.currentTarget.textContent || '')}
				...
				{canEdit ? (
					<>
						...
						<input
							...
							onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleFieldChange('github', e.target.value || undefined)}
						...
						<input
							...
							onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleFieldChange('npm', e.target.value || undefined)}
