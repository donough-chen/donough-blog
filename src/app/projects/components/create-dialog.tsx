			...
			<div>
					...
					<div className='flex-1'>
						...
						<div className='mt-1 flex items-center gap-2'>
							<input
								type='number'
								value={formData.year}
								onChange={(e: React.ChangeEvent<HTMLInputElement>) => setFormData({ ...formData, year: parseInt(e.target.value) || 0 })}
								placeholder='年份'
				...
				<div className='mt-3 space-y-2'>
					<input
						...
						onChange={(e: React.ChangeEvent<HTMLInputElement>) => setFormData({ ...formData, github: e.target.value || undefined })}
					...
					<input
						type='url'
						value={formData.npm || ''}
						onChange={(e: React.ChangeEvent<HTMLInputElement>) => setFormData({ ...formData, npm: e.target.value || undefined })}
